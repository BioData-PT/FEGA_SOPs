...
This SOP defines the standardized workflow for managing Helpdesk tickets in Request Tracker (RT) for Portugal. It ensures consistent handling, clear ownership, timely communication, complete internal traceability, and compliance with applicable security and privacy requirements. The service objective is to provide a **first response** within the time estabilished in the Service Level Agreement of each node.

## Scope

This SOP applies to all Helpdesk staff handling tickets in RT for Portugal, across all queues under `Queue List`. It covers ticket intake, triage, assignment, investigation, escalation, user communication, documentation, and closure.
...
3. If user does not respond:
   ...
   * Send Reminder 1 after 7 days
   * Send Reminder 2 (final) after 7 days
   * Close after 7 days (see “No Reply Closure”)
...
1. Send a final reminder (“We will close in 7 days if no response”).
2. After 7 days since last user reply:
...
We aim to respond within 48 working hours and will update you at least every week while this is in progress.”

### B) Waiting on dev update

“Quick update: this is now tracked internally as {{ISSUE_ID}}. At the moment we are waiting for {{blocking item}}. I will update you again if further assistence is required or any change occurs.”
...
2. {{item}}
3. {{item}}
   If any of this contains sensitive data, please do not include credentials in plain text.”
...
“We have not heard back from you. If we do not receive a response within 7 days, we will close this ticket. You can reply at any time to reopen it.”
...
* Weekly review by Helpdesk Lead:
  ...
  * Tickets without owner > 48 hours
...
* SOP review frequency: every 12 months, or after any major process/tool change.

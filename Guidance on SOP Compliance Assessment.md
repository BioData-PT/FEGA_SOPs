...
2) Run the relevant checklist (All, Template, Instance).  
3) Record findings in the PR or an issue.  
4) Approve when all mandatory items pass; track optional improvements.

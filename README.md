...
| --- | --- | ---: | --- | --- | --- | ---: | --- |
| Grant submitter role to FEGA user using the Helpdesk Portal | [FEGA-SOP0013](sop/FEGA-SOP0013_SOP_for_Federated_EGA_Helpdesk_-_Grant_submitter_role_to_FEGA_user_using_the_Helpdesk_Portal.md) | v1.2 | SOP for Federated EGA Helpdesk | SOP | CEGA | 6 | 14-10-2025 |
| FEGA Request from submitter to submit to FEGA node | [FEGA-SOP0019](sop/FEGA-SOP0019_SOP_for_Federated_EGA_Request_from_submitter_to_submit_to_FEGA_node_-_v2.0.md) | v1.2 | SOP for Federated EGA Helpdesk | SOP | CEGA | 7 | 14-10-2025 |
